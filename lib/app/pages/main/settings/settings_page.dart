...
import 'package:stimmapp/app/pages/others/about_page.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              if (_isGoogleAccount && userProfile != null) ...[
                SwitchListTile(
                  key: const Key('googleProfileSyncSwitch'),
                  contentPadding: EdgeInsets.zero,
                  value: userProfile.isGoogleSyncActive == true,
                  onChanged: _isSyncingGoogleProfile
                      ? null
                      : (active) => _setGoogleSyncActive(userProfile, active),
                ...
                ListTile(
                  ...
                  onTap: _isSyncingGoogleProfile
                      ? null
                      : () => _syncGoogleProfileNow(userProfile),
                ),
              ],
              ListTile(
